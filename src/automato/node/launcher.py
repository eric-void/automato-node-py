...
def boot_test():
  ...
  tests = [ system_test, nodes_test, health_test, toggle_test, shelly_test, tasmota_test, rf_listener_test, rf2mqtt_listener_test, location_owntracks_test, net_sniffer_scapy_test, net_sniffer_iw_test, presence_test, owrtwifi2mqtt_test, scheduler_test ] if args.test == "*" else [ globals()[args.test] ]
