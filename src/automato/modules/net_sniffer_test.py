...
def test_run(entries):
  ...
  entries['net_sniffer@TEST'].module._iwevent_process_line(entries['net_sniffer@TEST'], 'new station 01:02:03:04:05:06')
  test.waitRunning()
  ...
  entries['net_sniffer@TEST'].module._iwevent_process_line(entries['net_sniffer@TEST'], 'new station 0A:0B:0C:0D:0E:0F')
  test.waitRunning()
  ...
  x = entries['net_sniffer@TEST'].module._arp_process_line("192.168.1.199    0x1         0x0         01:02:03:04:05:06     *        br-lan")
  ...
  entries['net_sniffer@TEST'].module.mac_address_detected(entries['net_sniffer@TEST'], env, '01:02:03:04:05:06', connected = True, confidence = True, ip_address = None, handler = 'test', event_monitor = False)
  test.waitRunning()
  ...
  entries['net_sniffer@TEST'].module.mac_address_detected(entries['net_sniffer@TEST'], env, '01:02:03:04:05:06', connected = False, confidence = True, ip_address = None, handler = 'test', event_monitor = False)
  test.waitRunning()
